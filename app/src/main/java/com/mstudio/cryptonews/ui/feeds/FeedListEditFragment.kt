...
package com.mstudio.cryptonews.ui.feeds
...
import com.mstudio.cryptonews.ui.views.DragNDropListener
...
class FeedListEditFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        com.mstudio.cryptonews.App.db.feedDao().observeAllWithCount.observe(this, Observer { nullableFeeds ->
                        ...
                        .setPositiveButton(android.R.string.ok) { dialog, which ->
                            ...
                            if (groupName.isNotBlank()) {
                                doAsync {
                                    ...
                                    com.mstudio.cryptonews.App.db.feedDao().insert(newGroup)
                                }
                            }
                        }
    ...
    private fun changeItemPriority(fromFeed: Feed, newDisplayPriority: Int) {
        ...
        doAsync {
            com.mstudio.cryptonews.App.db.feedDao().update(fromFeed)
        }
    }
}
